...
# Enable I2C, SPI, and Console Auto login
...
apt-get install git raspberrypi-kernel-headers || { echo "Error: Failed to install dependencies."; exit 1; }

# Compile and install display driver
...
#Compile and install keyboard device driver
